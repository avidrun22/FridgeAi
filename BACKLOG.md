...
- [ ] **v1.13 — three bug fixes + five shopping-list features** (submitted to App Store 2026-05-01, awaiting approval). Eight things in one ship:
...
- [ ] **v1.15 — Open Food Facts integration as a shipping milestone** (captured 2026-05-01 from Greg's feedback, sized 2026-05-01 as a discrete release). Today scan accuracy depends on whatever external barcode service we hit; coverage has gaps and we don't accumulate data across users. Two parallel paths, both valuable:
